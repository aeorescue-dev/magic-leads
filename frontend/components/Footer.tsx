        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href={localePath("/#preco")} className="hover:text-foreground transition-colors">{t("price.plan")}</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-sm font-semibold mb-3">{t("nav.dashboard")}</h4>
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href={localePath("/dashboard")} className="hover:text-foreground transition-colors">{t("nav.dashboard")}</a></li>
            </ul>
          </div>
        </div>
